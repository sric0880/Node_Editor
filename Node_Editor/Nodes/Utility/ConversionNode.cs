...
public class ConversionNode : Node 
{
	...
	public override Node Create (Vector2 pos) 
	{
		...
		node.inputType = new SerializedType (typeof(UnityEngine.Object));
		node.CreateInput ("Input", typeof(UnityEngine.Object).AssemblyQualifiedName);
		node.outputType = new SerializedType (typeof(UnityEngine.Object));
		node.CreateOutput ("Output", typeof(UnityEngine.Object).AssemblyQualifiedName);
	...
	protected internal override void NodeGUI () 
	{
		...
		if (inputType == null || !inputType.Validate ())
			inputType = new SerializedType (typeof(UnityEngine.Object));
		...
		if (outputType == null || !outputType.Validate ())
			outputType = new SerializedType (typeof(UnityEngine.Object));
