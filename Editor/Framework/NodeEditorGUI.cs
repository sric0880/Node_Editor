...
namespace NodeEditorFramework 
{
	public static class NodeEditorGUI 
	{
		...
		public static int knobSize = 20;

		public static Color NE_LightColor = new Color (0.4f, 0.4f, 0.4f);
		public static Color NE_TextColor = new Color (1f, 1f, 1f);

		public static Texture2D Background;
		public static Texture2D AALineTex;
		public static Texture2D GUIBox;
		public static Texture2D GUIButton;
		public static Texture2D GUIBoxHeader1;
		public static Texture2D GUIBoxHeader2;
		public static Texture2D GUIBoxHeader3;
		...
		public static GUIStyle nodeBoxHeader1;
		public static GUIStyle nodeBoxHeader2;
		public static GUIStyle nodeBoxHeader3;
		public static GUIStyle nodeBoxBody;
		...
		public static bool Init ()
		{
			...
			GUIBoxHeader1 = ResourceManager.LoadTexture("Textures/Header7.png");
			GUIBoxHeader2 = ResourceManager.LoadTexture("Textures/Header8.png");
			GUIBoxHeader3 = ResourceManager.LoadTexture("Textures/Header6.png");
			...
			nodeLabel = new GUIStyle(nodeSkin.label);
			...
			// Header Box
			nodeBoxHeader1 = new GUIStyle(nodeBox);
			nodeBoxHeader1.normal.background = GUIBoxHeader1;
			nodeBoxHeader2 = new GUIStyle(nodeBox);
			nodeBoxHeader2.normal.background = GUIBoxHeader2;
			nodeBoxHeader3 = new GUIStyle(nodeBox);
			nodeBoxHeader3.normal.background = GUIBoxHeader3;

			nodeBoxBody = new GUIStyle();
			nodeBoxBody.padding.right = 20;
			nodeBoxBody.padding.left = 20;
